...
const TransactionData = (props) => {
  ...
  return (
    <>
        ...
        <div className={classes.popup}>
          ...
          <table className={classes.table}>
            <tbody>
              ...
              {datatype=='invoice'? deletedInvoice.map((val, idx) => {
                return (
                  <tr id={idx}>
                    <td>{val.File_Name}</td>
      ...
      {props.monthSelected && <div className={classes.transactiondata}>
        <span>
          <a
            onClick={(e) => {
              e.preventDefault();
        ...
        <main>
          ...
          <button onClick={()=>{return setReportType((prevState)=>{return !prevState})}} style={{ marginLeft: "auto" }}>
            <FileDownloadOutlinedIcon className={classes.downloadicon} />
            Download Reports
        ...
        {reportType && <section className={classes.specialsection}>
          <p>Error Report <FileDownloadOutlinedIcon style={{fontSize:'2.5rem', color:'#4F2D7F'}}/> </p>
          <p>Section Mismatch Report <FileDownloadOutlinedIcon style={{fontSize:'2.5rem', color:'#4F2D7F'}}/> </p>
          <p>Out of TDS Scope Report <FileDownloadOutlinedIcon style={{fontSize:'2.5rem', color:'#4F2D7F'}}/> </p>
        </section>}

        <table style={reportType?{marginTop:'-13.5rem'}:{}} className={classes.table}>
          <tbody>
            <tr>
              <th>
                <input type="checkbox" name="" id="" />
            ...
            {datatype=='invoice' && invoiceData.map((val, idx) => {
              return (
                <tr id={idx}>
                  <td>
                    <input type="checkbox" name="" id="" />
            ...
            {datatype=='advance' && advanceData.map((val, idx) => {
              return (
                <tr id={idx}>
                  <td>
                    <input type="checkbox" name="" id="" />
            ...
            {datatype=='provision' && provisionData.map((val, idx) => {
              return (
                <tr id={idx}>
                  <td>
                    <input type="checkbox" name="" id="" />
