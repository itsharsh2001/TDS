  ...
  return (
    <div className={classes.transactionbalance}>
       <span>
        ...
        {/* <ChevronRightIcon className={classes.righticon} /> */}
        <a onClick={(e)=>{e.preventDefault();}} href="">Transaction Balance Master</a>
      </span>
      <ul>
        <li style={viewData=='transactionbalance'?hoverStyle:{}} onClick={()=>setViewData('transactionbalance')}>Transaction Balance</li>
      ...
      {viewData=='transactionbalance' && <Balance/>}
      {viewData=='enrichment' && <Enrichment/>}
      {viewData=='viewmaster' && <ViewMaster type= 'Balance'/>}
    </div>
  )
}
